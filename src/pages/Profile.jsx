  ...
  const handleCityBlur = async () => {
    ...
    try {
      const { data } = await api.get(
        `/auth/distance?city=${encodeURIComponent(formData.city)}`,
      );
      setFormData((prev) => ({ ...prev, distance: data.distance }));
    } catch (err) {
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 mb-8 max-w-xl mx-auto text-center transform hover:scale-[1.01] transition-transform">
          ...
          <p className="text-gray-500 mb-6 flex items-center justify-center gap-2">
            ...
            Verified {user.role === "admin" ? "Administrator" : "Student"}{" "}
            Profile
          </p>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 text-left border border-gray-100 mb-8">
            ...
            {success && (
              <div className="bg-green-50 text-green-600 p-3 rounded-lg text-sm font-medium mb-4">
                {success}
              </div>
            )}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    disabled={!isEditing}
                    className="w-full bg-transparent font-semibold text-gray-800 outline-none border-b border-transparent focus:border-blue-500 transition-colors disabled:opacity-70"
                  />
                </div>
              </div>
                  ...
                  <div className="flex items-center gap-4 border-t border-gray-200 pt-4">
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        disabled={!isEditing}
                        className="w-full bg-transparent font-semibold text-gray-800 outline-none border-b border-transparent focus:border-indigo-500 transition-colors disabled:opacity-70"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 border-t border-gray-200 pt-4">
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        disabled={!isEditing}
                        className="w-full bg-transparent font-semibold text-gray-800 outline-none border-b border-transparent focus:border-purple-500 transition-colors disabled:opacity-70"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 border-t border-gray-200 pt-4">
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        disabled={!isEditing}
                        className="w-full bg-transparent font-semibold text-gray-800 outline-none border-b border-transparent focus:border-orange-500 transition-colors disabled:opacity-70"
                      />
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-4 border-t border-gray-200 pt-4">
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          disabled={!isEditing}
                          className="w-full bg-transparent font-semibold text-gray-800 outline-none border-b border-transparent focus:border-green-500 transition-colors disabled:opacity-70"
                        />
                      </div>
                    </div>
                  ) : Number(formData.year) > 1 ? (
                        ...
                        {isEditing ? (
                          <>
                            <input
                              ...
                              className="w-full bg-transparent font-semibold text-gray-800 outline-none border-b border-blue-500 transition-colors pr-10"
                            />
                            {distanceLoading && (
                              <div className="absolute right-0 top-0 bottom-0 flex items-center pr-2">
                                <span className="animate-spin h-4 w-4 border-2 border-blue-500 border-t-transparent rounded-full font-bold"></span>
                              </div>
                            )}
                          </>
                        ) : (
                          <p className="font-semibold text-gray-800">
                            {user.city || "Not set"} •{" "}
                            {user.distance !== undefined ? user.distance : 0} km
                            from Campus
                          </p>
                        )}
                      </div>
                ...
                <button
                  ...
                  disabled={
                    ...
                    (formData.city &&
                      formData.distance === "" &&
                      !distanceError &&
                      formData.city.toLowerCase() !== "coimbatore")
                  }
                  className="w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-xl hover:bg-blue-700 transition flex justify-center items-center"
                >
