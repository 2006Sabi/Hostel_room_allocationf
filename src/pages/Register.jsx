...
const Register = () => {
  ...
  const validate = useCallback((values) => {
    ...
    // Conditional validation based on year
    if (values.year === "1") {
      if (!values.twelfthPercentage)
        errors.twelfthPercentage =
          "12th Percentage is required for first-year students";
    } else if (values.year && values.year !== "1") {
      if (!values.CGPA)
        errors.CGPA = "CGPA is required for second-year and above students";
    }
  ...
  const handleCityBlur = async () => {
    ...
    try {
      const { data } = await api.get(
        `/auth/distance?city=${encodeURIComponent(values.city)}`,
      );
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User
                    size={16}
                    className={`${touched.name ? (errors.name ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                  />
                </div>
                <input
                  type="text"
                  ...
                  className={`block w-full pl-10 pr-10 py-2.5 border rounded-xl focus:ring-2 transition-all outline-none text-sm ${
                    touched.name
                      ? errors.name
                        ? "border-red-300 bg-red-50 focus:ring-indigo-500"
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Mail
                    size={16}
                    className={`${touched.email ? (errors.email ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                  />
                </div>
                <input
                  type="email"
              ...
              {touched.email && errors.email && (
                <p className="mt-1 text-[10px] text-red-500 font-medium ml-1">
                  {errors.email}
                </p>
              )}
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock
                      size={16}
                      className={`${touched.password ? (errors.password ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                    />
                  </div>
                  <input
                    type="password"
                ...
                {touched.password && errors.password && (
                  <p className="mt-1 text-[10px] text-red-500 font-medium ml-1 leading-tight">
                    {errors.password}
                  </p>
                )}
              </div>
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock
                      size={16}
                      className={`${touched.confirmPassword ? (errors.confirmPassword ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                    />
                  </div>
                  <input
                    type="password"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Hash
                      size={16}
                      className={`${touched.registerNumber ? (errors.registerNumber ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                    />
                  </div>
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <BookOpen
                      size={16}
                      className={`${touched.department ? (errors.department ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                    />
                  </div>
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Calendar
                      size={16}
                      className={`${touched.year ? (errors.year ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                    />
                  </div>
                  <select
                    name="year"
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <BookOpen
                        size={16}
                        className={`${touched.twelfthPercentage ? (errors.twelfthPercentage ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                      />
                    </div>
                    <input
                      type="number"
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <BookOpen
                        size={16}
                        className={`${touched.CGPA ? (errors.CGPA ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                      />
                    </div>
                    <input
                      type="number"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      disabled
                      className="block w-full pl-10 pr-3 py-2.5 border border-gray-200 bg-gray-100 rounded-xl outline-none text-sm text-gray-400"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <MapPin
                      size={16}
                      className={`${touched.city ? (errors.city ? "text-red-400" : "text-green-500") : "text-gray-400"}`}
                    />
                  </div>
                  <input
                    type="text"
            ...
            <button
              ...
              disabled={
                ...
                (values.city &&
                  calculatedDistance === null &&
                  !distanceError &&
                  values.city.toLowerCase() !== "coimbatore")
              }
